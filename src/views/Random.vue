<template>
    <div class="wrapper">
        <button id="collagebutton" v-on:click="resetPhotos">Previous</button>
        <button id="collagebutton" v-on:click="resetPhotos">Random</button>
        <button id="collagebutton" v-on:click="resetPhotos">Next</button>
        <div class="images">
